...
export const ClassesTab = memo(({
  ...
  const [selectedClass, setSelectedClass] = useState<import("@/lib/types/school").SchoolClassRead | null>(null);
  ...
  const handleEditClick = (classItem: import("@/lib/types/school").SchoolClassRead) => {
