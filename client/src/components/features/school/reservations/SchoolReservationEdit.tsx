    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="col-span-2">
        <FormField
          ...
          onChange={(value) => setForm({ ...form, previous_school_details: value })}
        />
      </div>
    </div>
  </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="flex items-center gap-2">
        <Switch 
          ...
          onCheckedChange={(checked) => setForm({ ...form, transport_required: checked })} 
