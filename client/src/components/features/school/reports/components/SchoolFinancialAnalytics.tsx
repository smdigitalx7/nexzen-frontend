...
interface SchoolFinancialAnalyticsProps {
  incomeDashboard: any;
...
export const SchoolFinancialAnalytics = ({
  incomeDashboard,
  expenditureDashboard,
  loading,
}: SchoolFinancialAnalyticsProps) => {
  if (loading) {
    return (
  ...
  const monthlyTrend = [
    { month: "Jan", income: 45000, expenditure: 32000 },
    { month: "Feb", income: 52000, expenditure: 34000 },
    { month: "Mar", income: 48000, expenditure: 36000 },
    { month: "Apr", income: 61000, expenditure: 38000 },
    { month: "May", income: 55000, expenditure: 35000 },
    { month: "Jun", income: 67000, expenditure: 40000 },
  ];
