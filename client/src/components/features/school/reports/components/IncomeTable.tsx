...
import { useUpdateSchoolIncome, useSchoolIncome } from "@/lib/hooks/school/use-school-income-expenditure";
...
export const IncomeTable = ({
  ...
  // Fetch income details for viewing
  const { data: viewIncome, isLoading: isViewLoading, error: viewError } = useSchoolIncome(viewIncomeId);
