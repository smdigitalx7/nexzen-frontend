// Academic Management Feature Components
...
// Academic Shared Components
export { AcademicCard } from './academic/shared/AcademicCard';
export { AddClassDialog } from './academic/shared/AddClassDialog';
export { AddExamDialog } from './academic/shared/AddExamDialog';
export { AddSubjectDialog } from './academic/shared/AddSubjectDialog';
