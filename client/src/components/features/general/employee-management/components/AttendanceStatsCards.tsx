...
export const AttendanceStatsCards: React.FC<AttendanceStatsCardsProps> = ({
  ...
  const stats = [
    ...
    },
    {
      ...
      value: safePercentage(averageAttendance),
      icon: TrendingUp,
    ...
    {
      title: "Late Arrivals",
      value: safeNumber(totalLateArrivals),
      icon: Clock,
    ...
    },
    {
      ...
      value: safeNumber(totalEarlyDepartures),
      icon: UserX,
      color: "text-red-600",
      bgColor: "bg-red-50",
    },
    {
      title: "Paid Leaves",
      value: safeNumber(totalPaidLeaves),
      icon: UserCheck,
    ...
    {
      title: "Unpaid Leaves",
      value: safeNumber(totalUnpaidLeaves),
      icon: TrendingUp,
