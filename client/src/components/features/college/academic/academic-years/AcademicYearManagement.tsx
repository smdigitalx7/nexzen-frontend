...
const academicYearFormSchema = z.object({
  ...
  start_date: z.string().min(1, "Academic Year Start date is required"),
  end_date: z.string().min(1, "Academic Year End date is required"),
...
const AcademicYearManagement = () => {
  ...
  const { searchTerm, setSearchTerm, filteredItems: searchFiltered } = useSearchFilters<UIAcademicYearRow>(
    academicYears as UIAcademicYearRow[],
