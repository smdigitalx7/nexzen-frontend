...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-all duration-150 ease-in-out",
      "focus:bg-accent focus:text-accent-foreground",
      // Use more specific selectors to ensure hover works for all instances
      "data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground data-[highlighted]:font-medium",
      "[&[data-highlighted]]:bg-accent [&[data-highlighted]]:text-accent-foreground [&[data-highlighted]]:font-medium",
