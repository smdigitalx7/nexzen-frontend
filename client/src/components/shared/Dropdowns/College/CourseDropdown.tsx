...
import { useCollegeCourses } from "@/lib/hooks/college/use-college-dropdowns";
import type { CourseOption } from "@/lib/types/college/dropdowns";
...
export function CollegeCourseDropdown({
  ...
  const { data, isLoading, error, refetch } = useCollegeCourses(groupId);
