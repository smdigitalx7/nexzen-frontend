            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-lg p-5 border border-gray-200/60">
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center pt-1">
                  ...
                  <span className="text-sm font-semibold text-gray-900">{items.length} payment{items.length !== 1 ? 's' : ''}</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-amber-800 leading-relaxed">
                    Please verify that the amount being processed ({formatTotalAmount(totalAmount)}) matches the amount collected from the student. This action will process the payment and cannot be undone.
                  </p>
                </div>
              </div>
            </div>
