...
import { Truck, AlertCircle, CheckCircle, Lock } from 'lucide-react';
...
export const TransportFeeComponent: React.FC<PurposeSpecificComponentProps> = ({
  student,
  feeBalances,
  config,
  onAdd,
  ...
  const handleSubmit = () => {
    ...
    const paymentItem: PaymentItem = {
      id: `transport-fee-term-${selectedTerm}-${Date.now()}`,
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
            <h3 className="font-medium text-orange-800 mb-2">Term Status</h3>
            <div className="space-y-2 text-sm">
              {availableTerms.map((term) => (
                <div key={term.term} className="flex items-center justify-between">
                  <span className="text-orange-600">Term {term.term}:</span>
