...
import { CollegeSubjectList, CollegeSubjectResponse, CollegeCreateSubject, CollegeUpdateSubject, CollegeGroupSubjectCreate, CollegeGroupSubjectRead, CollegeGroupSubjectUpdate } from "@/lib/types/college";
