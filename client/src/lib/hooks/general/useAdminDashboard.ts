...
import type { AdminDashboardResponse } from "@/lib/types/general/dashboards";
import { isAdminDashboard } from "@/lib/types/general/dashboards";
...
export function useAdminDashboard(): UseDashboardDataReturn<AdminDashboardResponse> {
  ...
  const fetchDashboard = useCallback(async () => {
    ...
    try {
      ...
      if (isAdminDashboard(response)) {
        ...
        // If we got a different dashboard type, it means user doesn't have admin role
