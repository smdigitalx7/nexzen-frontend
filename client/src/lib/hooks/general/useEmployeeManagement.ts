...
import { useEmployeesByBranch, useEmployee, useCreateEmployee, useUpdateEmployee, useDeleteEmployee, useUpdateEmployeeStatus } from '@/lib/hooks/general/useEmployees';
import { useAttendanceAll, useAttendance, useCreateAttendance, useUpdateAttendance, useDeleteAttendance, useAttendanceByBranch } from '@/lib/hooks/general/useEmployeeAttendance';
import { useEmployeeLeaves, useEmployeeLeavesByBranch, useEmployeeLeaveById, useCreateEmployeeLeave, useUpdateEmployeeLeave, useApproveEmployeeLeave, useRejectEmployeeLeave, useDeleteEmployeeLeave } from '@/lib/hooks/general/useEmployeeLeave';
import { useAdvancesAll, useAdvancesByBranch, useAdvance, useCreateAdvance, useUpdateAdvance, useUpdateAdvanceStatus, useUpdateAdvanceAmountPaid } from '@/lib/hooks/general/useAdvances';
import { EmployeeCreate, EmployeeUpdate } from '@/lib/types/general/employees';
import { EmployeeAttendanceCreate, EmployeeAttendanceUpdate } from '@/lib/types/general/employee-attendance';
import { EmployeeLeaveCreate, EmployeeLeaveUpdate, EmployeeLeaveReject } from '@/lib/types/general/employee-leave';
