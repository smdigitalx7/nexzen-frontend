 ...
 * 
 * @deprecated Consider using the new global permissions system from @/core/permissions
 ...
 * 
 * Note: For new code, prefer using the global permissions system from @/core/permissions
 ...
 * 
 * @deprecated Consider using canView() from @/core/permissions instead
 */
 ...
 * 
 * @deprecated Consider using action-specific functions from @/core/permissions instead
 */
