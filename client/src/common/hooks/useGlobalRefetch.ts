...
/**
 * ✅ FIX: Selective batch invalidation to prevent UI freezing
 * Marks queries as stale without immediate refetch, then manually refetches with delays
 */
...
/**
 * @deprecated Use batchInvalidateQueriesSelective() instead for better performance
 */
