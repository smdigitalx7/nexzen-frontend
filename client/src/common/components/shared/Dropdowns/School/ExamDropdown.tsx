...
import { useSchoolExams } from "@/features/school/hooks/use-school-dropdowns";
import type { ExamOption } from "@/features/school/types/dropdowns";
...
export function SchoolExamDropdown({
  ...
  const { data, isLoading, error, refetch } = useSchoolExams({ enabled: shouldFetch });
