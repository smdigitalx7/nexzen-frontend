...
const AddTestMarksByClassDialog = ({
  ...
  const { data: testsData, isLoading: testsLoading } = useSchoolTests({ enabled: true }); // Fetching tests globally
  ...
  // Set test name when test is selected
  useEffect(() => {
      ...
      <DialogContent className="max-w-7xl w-full flex flex-col p-0 h-[85vh]">
        <DialogHeader className="px-6 pt-6 pb-4 border-b">
          ...
          <DialogDescription className="sr-only">
            Add test marks for multiple students in a class.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex flex-wrap gap-4 items-end py-4 border-b">
            ...
            <div className="w-48">
              ...
              <ServerCombobox
                ...
                onSelect={(val) => setSelectedTest(val ? Number(val) : null)}
                valueKey="test_id"
                labelKey="test_name"
