...
import { useStudentMarks } from "@/features/school/hooks";
import type { SubjectMarksDetail } from "@/features/school/types";
...
export const StudentMarksReportPage = ({
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      toast({ title: "Export successful", description: "Student marks have been exported to Excel." });
    } catch (err) {
