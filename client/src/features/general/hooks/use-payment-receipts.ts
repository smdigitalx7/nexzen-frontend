...
import { PaymentReceiptsService, PaymentReceiptData, PaymentReceiptResponse, PaymentReceiptListResponse } from "@/features/general/services/payment-receipts.service";
