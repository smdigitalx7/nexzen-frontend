...
import { generateAdvanceVoucherPDF } from "@/common/utils/export/advance-voucher-pdf";
    ...
    <>
      ...
      <EmployeeFormDialog
        ...
        onSubmit={async (e) => {
          ...
          const salaryNum = Number.parseFloat(selectedEmployee?.salary) || 0;
          if (isEditingEmployee && selectedEmployee?.employee_id) {
            ...
            await handleUpdateEmployee(selectedEmployee.employee_id, {
              ...updateData,
              salary: salaryNum,
            });
          } else {
