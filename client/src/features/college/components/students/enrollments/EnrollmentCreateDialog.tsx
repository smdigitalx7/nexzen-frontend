...
import type { CollegeEnrollmentCreate } from '@/features/college/types';
      ...
      <div className="space-y-4">
        <div>
          ...
          <ServerCombobox
            ...
            onSelect={(value: string) => onFormDataChange({ ...formData, student_id: Number(value) })}
            labelKey={(student: any) => `${student.admission_no} - ${student.student_name}`}
            valueKey="student_id"
