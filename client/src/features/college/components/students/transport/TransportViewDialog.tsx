...
import type { CollegeTransportAssignmentRead, CollegeTransportAssignmentUpdate } from '@/features/college/types';
import { useUpdateCollegeStudentTransportAssignment, useCancelCollegeStudentTransportAssignment } from '@/features/college/hooks';
...
export const TransportViewDialog = ({
  ...
  const cancelMutation = useCancelCollegeStudentTransportAssignment();
  ...
  const handleCancelTransport = useCallback(async () => {
    ...
    try {
      await cancelMutation.mutateAsync({
        assignmentId: viewAssignment.transport_assignment_id,
        payload: {
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium break-words">{viewAssignment.group_name || '-'}</p>
                  </div>
                </div>
              </div>
