import { CollegeClassDropdown, CollegeGroupDropdown, BusRouteDropdown } from "@/common/components/shared/Dropdowns";
...
export const TransportSearchForm = ({
  ...
  const groupId = query.group_id !== "" ? query.group_id : null;
