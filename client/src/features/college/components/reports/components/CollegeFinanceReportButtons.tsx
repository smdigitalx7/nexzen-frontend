...
export const CollegeFinanceReportButtons: React.FC<CollegeFinanceReportButtonsProps> = ({
  className,
}) => {
...
export default CollegeFinanceReportButtons;
