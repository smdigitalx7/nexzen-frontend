...
import { useCreateCollegeExamMarksMultipleSubjects } from '@/features/college/hooks/use-college-exam-marks';
import {
  useCollegeGroups,
  useCollegeSubjects,
  useCollegeExams,
        ...
        <div className="">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              {selectedClass && selectedGroup && selectedSubject && !selectedExam && (
                <Alert>
                  <AlertDescription>
